...
<div class="modal fade" id="modalMensajes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top:10%; overflow-y:visible;" >
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-box-open"></i> Entradas Vibro Block</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="vista_captura.php"> Entradas Vibro Block</a></li>
        </ul>
      </div>
                    ...
                    <div class="row form-group form-group-sm">
                        ...
                        <div class="col-sm-2 text-left">
                            <select class="form-control form-control-md" id="selectproducto" name="selectproducto">
                                ...
                                <?php   
                                    $sql        = ModeloMateriaPrima::showMPoVibro();
