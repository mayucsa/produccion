...
$var    = "area = 'VibroBlock' AND  estatus_emp = 'VIG'";
$columns = array(
    array( 'db' => 'nombre_emp',    'dt' => 0 ),
    array( 'db' => 'cantidad_emp',  'dt' => 1,
                    'formatter' => function( $d, $row ) {
            return number_format($d, 2, '.', ',' );
        } ),
    array(
        'db'        => 'fecha_registro', 'dt'        => 2
    ),
    array(
        'db'        => 'unidad_medida', 'dt'        => 3
    )
);
