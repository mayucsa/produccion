...
<div class="modal fade" id="modalMensajes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top:10%; overflow-y:visible;" >
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fas fa-tasks"></i> Producci&oacute;n VibroBlock</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="vista_captura.php"> Producci&oacute;n VibroBlock</a></li>
        </ul>
      </div>
            ...
            <div class="card">
                ...
                <form novalidate id="tablaCapturaVibro" onsubmit="return false" autocomplete="off" method="POST">
                    <div class="row form-group form-group-sm">
                        ...
                        <div class="col-sm-2 text-left">
                            <select class="form-control form-control-sm" id="selectproducto" name="selectproducto" onchange="selectProducto()">
                                ...
                                <?php   
                                    $sql        = ModeloProducto::showProductoVibro();
                        ...
                        <div class="col-sm-2 text-left">
                            ...
                            <span id="selectceldas" name="selectceldas" class="form-control form-control-sm" style="background-color: #E9ECEF;"></span>
                        </div>
                        <div hidden class="col-sm-1 text-left" style="font-size:13px">Piezas</div>
                        <div hidden class="col-sm-2 text-left">
                            <span id="spanpiezas" name="spanpiezas" class="form-control" style="background-color: #E9ECEF;" onchange="operaciones();"></span>
                        </div>
                    </div>
                    <div class="row form-group form-group-sm">
                    ...
                    <div class="row form-group form-group-sm">
                        ...
                        <div class="col-sm-2 text-left">
                            <input type="text" id="inputgravilla" name="inputgravilla" class="form-control form-control-sm validanumericos" placeholder="Latas" onchange="porcentaje();">
                        </div>
                        <div class="col-sm-2 text-left" style="font-size:13px">Segundos</div>
                        <div class="col-sm-2 text-left">
...
<script type="text/javascript">
    function porcentaje(id){
        ...
        var sum = (parseFloat($('#inputpolvo').val()) + parseFloat($('#inputgravilla').val()));
