...
<div class="modal fade" id="modalMensajes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top:10%; overflow-y:visible;" >
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fas fa-dolly-flatbed"></i> Desalojo Vibro Block</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="vista_captura.php"> Desalojo Vibro Block</a></li>
        </ul>
      </div>
            ...
            <div class="card">
                ...
                <form novalidate id="tablaDesalojoVibro" onsubmit="return false" autocomplete="off" method="POST">
                    <div class="row form-group form-group-sm">
                        ...
                        <div class="col-sm-3 text-left">
                            <select class="form-control form-group-sm" id="selectpresentacion" name="selectpresentacion" disabled>
                                <option selected="selected" value="0">[Seleccione una opción..]</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" style="width: 100%;" id="tablaInvVibro">
                            <thead>
                                <tr>
