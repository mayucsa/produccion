...
<!-- FIN DE MODAL -->
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fas fa-tasks"></i> Producci&oacute;n Linea 1</h1>
        </div>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover w-100 shadow" id="tableserverSideTPLinea1">
                                ...
                                <tbody>
                                    <tr ng-repeat="(i, obj) in ssProduccionLinea1 track by i">
                                        ...
                                        <td class="text-center" nowrap="nowrap">
                                            <span class= "btn btn-warning btn-sm" ng-show="perfilUsu.produccion_trituradoral1_edit == 1" ng-click="obtenerDatosEdit(obj.cve_pt)" title="Editar" data-toggle="modal" data-target="#modalEditar" data-whatever="@getbootstrap"><i class="fas fa-edit"></i> </span>
                                            <span class= "btn btn-danger btn-sm" ng-show="perfilUsu.produccion_trituradoral1_edit == 1" ng-click="eliminartp(obj.cve_pt)" title="Eliminar"><i class="fas fa-trash-alt"></i> </span>
                                            <span class= "btn btn-warning btn-sm" ng-show="perfilUsu.produccion_trituradoral1_edit == 0" ng-click="sinacceso()" title="Editar"><i class="fas fa-edit"></i> </span>
                                            <span class= "btn btn-danger btn-sm" ng-show="perfilUsu.produccion_trituradoral1_edit == 0" ng-click="sinacceso()" title="Eliminar"><i class="fas fa-trash-alt"></i> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
