...
<div ng-controller="VistaTPLinea2">
...
<div id="modalEditar" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fas fa-clock"></i> Tiempo p&eacute;rdido Linea 2</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="tiempoperdido2_vista.php"> Tiempo p&eacute;rdido</a></li>
        </ul>
      </div>
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="card card-info" ng-show="perfilUsu.tperdido_trituradoral2_captura == 1">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover w-100 shadow" id="tableserverSideTPLinea2">
                                ...
                                <tbody>
                                    <tr ng-repeat="(i, obj) in serverSideTPLinea2 track by i">
                                        <td>{{obj.cve_tp}}</td>
                                        ...
                                        <td nowrap="nowrap">
                                            <span class= "btn btn-warning btn-sm" ng-show="perfilUsu.tperdido_trituradoral2_edit == 1" ng-click="obtenerDatosEdit(obj.cve_tp)" title="Editar" data-toggle="modal" data-target="#modalEditar" data-whatever="@getbootstrap"><i class="fas fa-edit"></i> </span>
                                            <span class= "btn btn-danger btn-sm" ng-show="perfilUsu.tperdido_trituradoral2_edit == 1" ng-click="eliminartp(obj.cve_tp)" title="Eliminar"><i class="fas fa-trash-alt"></i> </span>
                                            <span class= "btn btn-warning btn-sm" ng-show="perfilUsu.tperdido_trituradoral2_edit == 0" ng-click="sinacceso()" title="Editar"><i class="fas fa-edit"></i> </span>
                                            <span class= "btn btn-danger btn-sm" ng-show="perfilUsu.tperdido_trituradoral2_edit == 0" ng-click="sinacceso()" title="Eliminar"><i class="fas fa-trash-alt"></i> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
