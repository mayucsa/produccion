...
app.controller('VistaTPLinea1', function(BASEURL, ID, $scope, $http){
	...
	$http.post('Controller.php', {
		...
		console.log('getMaquinasL1', response);
	...
	$http.post('Controller.php', {
		'task': 'serverSideTPLinea1'
	}).then(function (response){
		response = response.data;
		console.log('serverSideTPLinea1', response);
		$scope.serverSideTPLinea1 = response;
		setTimeout(function(){
...
app.controller('VistaTPLinea2', function(BASEURL, ID, $scope, $http){
	$scope.ordenServicioDisabled = true;
	$scope.oservicio = '';
	$http.post('Controller.php', {
		'task': 'getMaquinasL2'
		...
		response = response.data;
		console.log('getMaquinasL2', response);
		$scope.Maquinas = response;
	},function(error){
		console.log('error', error);
	});
	...
	$http.post('Controller.php', {
		'task': 'serverSideTPLinea2'
	}).then(function (response){
		response = response.data;
		console.log('serverSideTPLinea2', response);
		$scope.serverSideTPLinea2 = response;
		setTimeout(function(){
