              ...
              <div class="tile">
                <div class="tile-body">
                    <div class="card">
                        <div class="card-body">
                            <div class="img">
                                <img class="rounded mx-auto d-block" src="../../../includes/imagenes/juntos3.png">
                            </div>
                            <div class="col-md-12 text-center mt-5 mb-5">
                                <h1> Bienvenido(a) <?php echo $nombre." ".$apellido?> a nuestra Plataforma Web de Producci&oacute;n</h1>
                            </div>
                            <div class="col-md-12 text-center mt-5 mb-5">
