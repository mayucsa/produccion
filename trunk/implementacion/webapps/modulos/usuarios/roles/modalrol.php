  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form novalidate id="formrol" onsubmit="return false" autocomplete="off" name="formrol" method="POST">
...
<!-- MODAL DE EDITAR LOS PERMISOS DE USUARIO OBTIENE LOS DATOS PARA REALIZARE EL UPDATE-->
<!-- <div id="modalrolupdate" class="modal fade" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
      ...
      <div class="modal-body">
        <form novalidate id="formrolup" onsubmit="return false" autocomplete="off" name="formrolup" method="POST">
          <div class="form-group">
            <label class="control-label">Nombre</label>up
            <input class="form-control" id="txtnameup" name="txtname" type="text" placeholder="Nombre del rol">
          </div>
          <div class="form-group">
            <label class="control-label">Descripción</label>
            <textarea class="form-control" id="txtdescripcionup" name="txtdescripcionup" rows="2" placeholder="Descripción del Rol" ></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">Estatus</label> 
            <select class="form-control" id="selectStatusup" name="selectStatusup">
