...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2', 'INVENTARIO LABORATORIO');
...
// ->setCellValue('C3', 'Cantidad en KG')        
// ->setCellValue('D3', 'Cantidad en Tonelada')
...
// $objPHPExcel->setActiveSheetIndex(0)->getStyle('H3:I3')->applyFromArray($encabezado);
	...
	foreach ($datos as $clave) {
            ...
            // ->setCellValue('C'.$ite, $clave['cantidad'])
            // ->setCellValue('D'.$ite, $clave['tonelada'])
            // ->setCellValue('E'.$ite, $clave['sacos'])
            // ->setCellValue('F'.$ite, $clave['tipo'])
            ;
