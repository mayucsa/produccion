...
if ( isset($_GET['accion']) && $_GET['accion'] == "insertar") {
    ...
    $sql		= "INSERT INTO seg_tiempoperdido (cve_maq, cve_fallo, motivo_fallo, hora_inicio, hora_fin, area, capturado_por, eliminado_por, estatus_tp, fecha_registro, fecha_eliminado) VALUES (:maquina, :fallo, :motivo, :horainicio, :horafin, 'Besser', :usuario, '', 'VIG', NOW(), 0);";
